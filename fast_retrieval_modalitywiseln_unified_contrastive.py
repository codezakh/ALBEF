...
from models.unified.contrastive import VisionLanguageLearner 
...
def main(args, config):
    ...
    model = VisionLanguageLearner(config=config, text_encoder=args.text_encoder, tokenizer=tokenizer)
